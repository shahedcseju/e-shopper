...
//    exit();
    ...
    $query_result=$obj_app->select_catgory_product_info_by_id($category_id);
        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                ...
                <div class="recommended_items"><!--recommended_items-->
                    <h2 class="title text-center">Releted items</h2>
                        ...
                        <?php while ($category_product=  mysqli_fetch_assoc($query_result)) { ?>        
                                <div class="col-sm-4">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="assets/<?php echo $category_product['product_image']; ?>" alt="" width="225" height="225" />
