<?php
    ...
    if(isset($_GET['status'])) {
        ...
        if($_GET['status'] == 'unpublished') {
            $meassage=$obj_sup_admin->unpublished_manufacturer_by_id($manufacturer_id); 
        }
        else if($_GET['status'] == 'published') {
            $meassage=$obj_sup_admin->published_manufacturer_by_id($manufacturer_id); 
        }
        else if($_GET['status'] == 'delete') {
            $meassage=$obj_sup_admin->delete_manufacturer_by_id($manufacturer_id); 
        }
    }



    $query_result=$obj_sup_admin->select_all_manufacturer_info();
?>
